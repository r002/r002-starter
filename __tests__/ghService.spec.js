 ...
 */
describe("gh-int-1: Fetch issues from unauth API", () => {
  it("gh-int-1.1: should fetch the desired number of issues", () => {
...
// describe("gh-int-2: Filter an issue collection by issue author (userLogin)", () => {
//   it("gh-int-2.1: should only return issues authored by userLogin", () => {
...
//   it("gh-int-2.2: should only return issues authored by userLogin", () => {
//     const numberOfIssues = 10
//     const userLogin = "r002"
//     return getIssues(numberOfIssues).then(collection => {
 ...
 */
describe("gh-unit-1: Fetch 100 issues from the flat file", () => {
  it("gh-unit-1.1: should fetch the desired number of issues from mock", () => {
    const numberOfIssues = 5
...
describe("gh-unit-2: Filter an issue collection by issue author (userLogin)", () => {
  it("gh-unit-2.1: should only return issues authored by userLogin", () => {
